...
# 创建日志目录
log_dir="/home/guest/data/IKEA/auto_ragtheif_experiment_logs"
mkdir -p $log_dir
    ...
    for emb_model in "${emb_models[@]}"; do
        for dataset in "${datasets[@]}"; do
            for defense_policy in "${defense_policies[@]}"; do
                ...
                # 构造命令
                cmd=(
                    /home/guest/conda3/envs/KG_extract/bin/python /home/guest/rag-framework/rag_theif_pipeline.py
                    --dataset "$dataset"
